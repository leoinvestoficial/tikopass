  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(16 85% 55% / 0.3)" },
          "50%": { boxShadow: "0 0 20px 4px hsl(16 85% 55% / 0.15)" },
        },
      },
      animation: {
        ...
        "reveal-right": "reveal-right 0.6s cubic-bezier(0.16, 1, 0.3, 1) both",
        "reveal-scale": "reveal-scale 0.6s cubic-bezier(0.16, 1, 0.3, 1) both",
